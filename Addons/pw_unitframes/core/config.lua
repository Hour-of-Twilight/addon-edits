...
local config = {
	...
	auras = {
		...
		start_y = -20, -- auras start position by y-axis (buffs)
		...
		debuffs_offset_y = 5, -- vertical growth offset between debuffs 5 default
		e_debuffs_offset_y = -30, -- vertical growth offset between debuffs on enemy frame
		
		-- maximum number of buffs/debuffs:
		target_maxbuffs = 0, -- max buffs show, recommended to set value between 8-16
	...
	party = {
		...
		-- auras:
		show_buffs = false, -- show party buffs
		show_debuffs = false, -- show party debuffs
