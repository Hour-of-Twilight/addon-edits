...
--]]
	...
	--> constants
		...
		_detalhes.classstring_to_classid = {
			...
			["WARLOCK"] = 9,
			["DRUID"] = 10,
			["TIMEWALKER"]= 10, -- Uses same id as druid.
		}
		_detalhes.classid_to_classstring = {
			...
			[8] = "MAGE",
			[9] = "WARLOCK",
			[10] = "TIMEWALKER", -- note: "DRUID" can't be retrieved from this table as it shares id with "TIMEWALKER"
		}
