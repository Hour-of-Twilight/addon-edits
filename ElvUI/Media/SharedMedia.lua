...
E.Media = {
	...
	ToxiTextures = {
		...
		StylizedDPS = M .. [[Roles\StylizedDPS.blp]],
		StylizedHealer = M .. [[Roles\StylizedHealer.blp]],
		StylizedTank = M .. [[Roles\StylizedTank.blp]],
	...
	Textures = {
		...
		ToxiUI_half = M .. [[Textures\ToxiUI-half.tga]],
		ToxiUI_clean = M .. [[Textures\ToxiUI-clean.tga]],
		ToxiUI_g1 = M .. [[Textures\ToxiUI-g1.tga]],
		ToxiUI_g2 = M .. [[Textures\ToxiUI-g2.tga]],
		ToxiUI_grad = M .. [[Textures\ToxiUI-grad.tga]],
...
LSM:Register("font", "ToxiUI", E.Media.Fonts.ToxiUI, LSM.LOCALE_BIT_ruRU + LSM.LOCALE_BIT_western)
...
LSM:Register("font", "MontserratExtraBold", E.Media.Fonts.MontserratExtraBold,
	LSM.LOCALE_BIT_ruRU + LSM.LOCALE_BIT_western)
LSM:Register("font", "MontserratExtraLight", E.Media.Fonts.MontserratExtraLight,
	LSM.LOCALE_BIT_ruRU + LSM.LOCALE_BIT_western)
...
LSM:Register("font", "MontserratSemiBold", E.Media.Fonts.MontserratSemiBold, LSM.LOCALE_BIT_ruRU + LSM
	.LOCALE_BIT_western)
...
LSM:Register("statusbar", "ToxiUI-half", E.Media.Textures.ToxiUI_half)
LSM:Register("statusbar", "ToxiUI-clean", E.Media.Textures.ToxiUI_clean)
LSM:Register("statusbar", "ToxiUI-g1", E.Media.Textures.ToxiUI_g1)
LSM:Register("statusbar", "ToxiUI-g2", E.Media.Textures.ToxiUI_g2)
LSM:Register("statusbar", "ToxiUI-grad", E.Media.Textures.ToxiUI_grad)
