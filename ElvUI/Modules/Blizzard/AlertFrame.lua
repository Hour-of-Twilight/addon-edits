...
function B:AlertMovers()
	...
	if type(_G["AlertFrame_FixAnchors"]) == "function" then
		self:SecureHook("AlertFrame_FixAnchors", E.PostAlertMove)
	end
	if type(_G["AchievementAlertFrame_FixAnchors"]) == "function" then
		self:SecureHook("AchievementAlertFrame_FixAnchors")
	end
	if type(_G["DungeonCompletionAlertFrame_FixAnchors"]) == "function" then
