...
function UF:Construct_TargetFrame(frame)
	...
	E:CreateMover(frame, frame:GetName() .. "Mover", L["Target Frame"], nil, nil, nil, "ALL,SOLO", nil,
...
function UF:Update_TargetFrame(frame, db)
	...
	do
		...
		(frame.USE_MINI_CLASSBAR and (frame.SPACING + (frame.CLASSBAR_HEIGHT / 2)) or (frame.CLASSBAR_HEIGHT + frame.SPACING))
