...
function UF:Configure_CustomTexts(frame)
	...
	if db.customTexts then
		...
		for objectName, _ in pairs(db.customTexts) do
			...
			frame.customTexts[objectName]:FontTemplate(customFont, objectDB.size or UF.db.fontSize,
			...
			frame.customTexts[objectName]:Point(objectDB.justifyH or "CENTER", attachPoint, objectDB.justifyH or "CENTER",
				objectDB.xOffset, objectDB.yOffset)
