...
function UF:UpdateRangeCheckSpells()
	...
	local classSpellRange = E.global and E.global.unitframe and E.global.unitframe.spellRangeCheck and E.global.unitframe.spellRangeCheck[E.myclass]

	if type(classSpellRange) ~= "table" then
		return
	end

	for tbl, spells in pairs(classSpellRange) do
		AddTable(tbl)
