...
local function GetSpecName()
	...
	if (specIdx and specIdx ~= 0) and (specName and specName ~= "") then
		return (EnglishSpecName[E.myclass] and EnglishSpecName[E.myclass][specIdx]) or specName or "None"
	else
		return "None"
	end
end
...
function E:CreateStatusFrame()
	...
	StatusFrame.Section3.Content.Line3.Text:SetFormattedText("Class: |cff4beb2c%s|r", EnglishClassName[E.myclass] or E.myLocalizedClass or E.myclass)
