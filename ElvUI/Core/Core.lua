...
E.myServerClassName, E.myServerClassToken, E.myServerClassID = E.myLocalizedClass, E.myclass, nil
E.myLocalizedRace, E.myrace = UnitRace("player")
E.myname = UnitName("player")
E.myrealm = GetRealmName()

-- Compatibility fallback for custom/unsupported classes on modified 3.3.5a clients
if not RAID_CLASS_COLORS[E.myclass] then
	RAID_CLASS_COLORS[E.myclass] = { r = 0.41, g = 0.8, b = 0.94, colorStr = "ff69ccf0" }
end

if CUSTOM_CLASS_COLORS and not CUSTOM_CLASS_COLORS[E.myclass] then
	CUSTOM_CLASS_COLORS[E.myclass] = RAID_CLASS_COLORS[E.myclass]
end
...
E.ClassRole.TIMEWALKER = E.ClassRole.TIMEWALKER or "Caster"
E.ClassRole[E.myclass] = E.ClassRole[E.myclass] or "Melee"
...
E.DispelClasses.TIMEWALKER = E.DispelClasses.TIMEWALKER or {}
E.DispelClasses[E.myclass] = E.DispelClasses[E.myclass] or {}
E.HealingClasses.TIMEWALKER = E.HealingClasses.TIMEWALKER or nil
